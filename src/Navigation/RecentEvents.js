...
class RecentEvents extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://corsproxy.io/?https://n0nhj9ge18.execute-api.us-west-2.amazonaws.com/beta/rid?query=recentEvents',
                {headers:{
...
<div class="py-8 bg-blue-300 justify-center items-center" style={{minHeight: "100vh", flex: 0}} >
    ...
    <h1 class="text-center font-bold text-white text-4xl">Recent Events</h1>
    </div>
